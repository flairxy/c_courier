        ...
        <div class="block block-content block-content-full">
            <div class="row">
                ...
                <div class="block-content">
                    ...
                    <div class="form-group row" id="newPickupAddress" style="display: none">
                        ...
                        <div class="col-lg-6">
                            ...
                            <textarea class="form-control" id="example-textarea-input" name="pickup_address" rows="3"
                                placeholder="{{ $shipment->pickup_address }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('receiver_email') is-invalid @enderror"
                                    id="rp" value="{{ $shipment->receiver_email }}" name="receiver_email"
                    ...
                    <form method="POST" action="{{ route('admin.shipments.isDelivered', $shipment->id) }}">
                        @csrf
                        @if (!$shipment->is_received)
                        <div class="form-group">
                            <button type="submit" class="btn btn-alt-success" onclick="return confirm('Are you sure you want to mark this shipment as delivered')">Mark as Delivered</button>
                        </div>
                        @endif
                    </form>
                </div>
